...
import java.util.List;
    ...
    public class BlogController {
        ...
        @ApiResponse(responseCode = "200", description = "Successfully retrieved list of blogs",
        ...
        public ResponseEntity<BlogDTO> getBlogById(
                @Parameter(description = "ID of the blog post to be retrieved", required = true)
        ...
        public ResponseEntity<BlogDTO> createBlog(
                @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Blog post object to be created", required = true,
                        content = @Content(schema = @Schema(implementation = BlogDTO.class)))
        ...
        public ResponseEntity<BlogDTO> updateBlog(
                @Parameter(description = "ID of the blog post to be updated", required = true)
                @PathVariable Long id,
                @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Updated blog post object", required = true,
                        content = @Content(schema = @Schema(implementation = BlogDTO.class)))
                @RequestBody BlogDTO blogDTO) {
        ...
        public ResponseEntity<Void> deleteBlog(
                @Parameter(description = "ID of the blog post to be deleted", required = true)
                @PathVariable Long id) {
